<%@ Page Title="Imprimir Factura AYN RAND" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ImprimirFacturaAYNRAND.aspx.cs" Inherits="ImprimirFacturaAYNRAND" %>
...
<div class="divBusqueda">
            ...
            <tr>
                <td>
                    <h1 class="label">
                        ...
                        &nbsp;Imprimir Factura AYN RAND<asp:HiddenField ID="hfIdComprobante" 
                            runat="server" />
                    </h1>
                </td>
            </tr>
 ...
 <div class="toolbar">
    ...
    WaitMessageFont-Size="14pt" Width="100%">
                    <LocalReport ReportPath="FacturaAYNRAND.rdlc">
                        <DataSources>
