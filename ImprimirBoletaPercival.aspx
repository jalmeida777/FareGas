<%@ Page Title="Imprimir Boleta Percival" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ImprimirBoletaPercival.aspx.cs" Inherits="ImprimirBoletaPercival" %>
...
<div class="divBusqueda">
            ...
            <tr>
                <td>
                    <h1 class="label">
                        ...
                        &nbsp;Imprimir Boleta Percival<asp:HiddenField ID="hfIdComprobante" 
                            runat="server" />
                    </h1>
                </td>
            </tr>
 ...
 <div class="toolbar">
    ...
    WaitMessageFont-Size="14pt" Width="100%">
                    <LocalReport ReportPath="BoletaPERCIVAL.rdlc">
                        <DataSources>
